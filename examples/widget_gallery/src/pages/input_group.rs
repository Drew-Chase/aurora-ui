...
pub fn page_input_group() -> impl Widget {
    col!()
        ...
        .child(crate::example_section(
            "Default",
            "Combine inputs with labels or buttons.",
        ))
        .child(crate::example_card(
            col!()
                .spacing(16.0)
                .child(
                    input_group::InputGroup::new(TextInput::new().placeholder("Amount"))
                        .prefix(Text::new("$")),
                )
                .child(
                    input_group::InputGroup::new(TextInput::new().placeholder("Search..."))
                        .suffix(button!("Go")),
                ),
        ))
        .child(
