...
pub fn page_scroll_area() -> impl Widget {
    col!()
        ...
        .child(crate::example_section(
            "Default",
            "Content that exceeds the height becomes scrollable.",
        ))
        .child(crate::example_card(
            scroll_area::ScrollArea::new().height(200.0).child(
                col!()
                    .spacing(8.0)
                    ...
                    .child(Text::new("Item 7"))
                    .child(Text::new("Item 8"))
                    .child(Text::new("Item 9"))
                    .child(Text::new("Item 10"))
                    .child(Text::new("Item 11"))
                    .child(Text::new("Item 12")),
            ),
        ))
        .child(
