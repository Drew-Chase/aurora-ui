    ...
    col!()
        ...
        .child(crate::example_card(
            dropdown_menu::DropdownMenu::new()
                .trigger(button!("Open Menu").background_color(colors::SECONDARY).hover_background_color(Color::new(50, 50, 54, 255)).border_radius(Corners::all(6.0)).width(120).height(36))
