...
pub fn page_date_picker() -> impl Widget {
    col!()
        ...
        .child(crate::page_header("Date Picker", "A date input that opens a calendar dropdown."))
        .child(crate::example_section("Default", "Click to open the calendar and select a date."))
