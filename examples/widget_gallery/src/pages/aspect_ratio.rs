...
pub fn page_aspect_ratio() -> impl Widget {
    col!()
        ...
        .child(crate::example_section(
            "Presets",
            "Common aspect ratios have convenience constructors.",
        ))
            ...
            row!()
                ...
                .child(
                    col!()
                        ...
                        .child(
                            aspect_ratio::AspectRatio::widescreen().width(200.0).child(
                                BoxWidget::new()
                ...
                .child(
                    col!()
                        ...
                        .child(
                            aspect_ratio::AspectRatio::standard().width(200.0).child(
                                BoxWidget::new()
                                    .background_color(crate::theme::colors::muted())
                                    .corners(Corners::all(8.0)),
                            ),
                ...
                .child(
                    col!()
                        ...
                        .child(
                            aspect_ratio::AspectRatio::square().width(150.0).child(
                                BoxWidget::new()
                                    .background_color(crate::theme::colors::muted())
                                    .corners(Corners::all(8.0)),
                            ),
