...
pub fn page_menubar() -> impl Widget {
    col!()
        ...
        .child(crate::page_header("Menubar", "A horizontal application menu bar with dropdown sub-menus."))
        .child(crate::example_section("Default", "Click a menu title to open its dropdown."))
